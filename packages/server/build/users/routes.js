...
router.post('/users', validationHandler_1.default([
    { schema: validators_1.default.UserSignUpValidator, target: 'body' },
]), controller_1.signUp);
router.post('/users/user/tokens', validationHandler_1.default([
    { schema: validators_1.default.UserLoginValidator, target: 'body' },
]), controller_1.logIn);
router.post('/users/user', validationHandler_1.default([{ schema: validators_1.default.EmailValidator, target: 'body' }]), controller_1.requestPasswordResetEmail);
router.patch('/users/user/:token/confirm', controller_1.verifyEmail);
router.patch('/users/user/reset', authenticationHandler_1.default, validationHandler_1.default([
    { schema: validators_1.default.ResetPasswordValidator, target: 'body' },
]), controller_1.resetPassword);
router.patch('/users/user/profile', authenticationHandler_1.default, multer_1.default({ storage: fileStorage_1.default, fileFilter: fileFilter_1.default }).fields([
