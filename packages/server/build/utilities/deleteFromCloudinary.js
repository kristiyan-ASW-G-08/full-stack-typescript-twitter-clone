...
// @eslint/ignore
const deleteCloudinaryFile = (public_id) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        // @ts-ignore
        ...
        throw new RESTError_1.default(status, message);
    }
});
exports.default = deleteCloudinaryFile;
