...
const rateLimiter = ({ ip }, res, next) => __awaiter(void 0, void 0, void 0, function* () {
    try {
        yield idRateLimiter.consume(ip);
        next();
    }
    catch (err) {
        const { status, message } = RESTError_1.errors.TooManyRequests;
